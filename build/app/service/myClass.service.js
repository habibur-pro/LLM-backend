...
const nextLecture = (classId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const currentLecture = course.modules[currentModuleIndex].lectures[currentLectureIndex];
...
const getSingleClassWithProgress = (classId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const processedModules = course.modules.map((courseModule) => {
        const moduleProgress = myClassModules.find((item) => item.module.toString() === courseModule._id.toString());
        const isModuleCompleted = !!(moduleProgress === null || moduleProgress === void 0 ? void 0 : moduleProgress.isCompleted);
        ...
        const processedLectures = courseModule.lectures.map((lecture) => {
            ...
            const lectureWatched = moduleProgress === null || moduleProgress === void 0 ? void 0 : moduleProgress.lectures.find((watchedLec) => watchedLec.lecture.toString() === lecture._id.toString());
            // Check if the lecture is completed or is the current lecture being watched.
            const isLectureCompleted = !!lectureWatched;
            const isCurrentLecture = lecture._id.toString() === ((_a = myClass.currentLecture) === null || _a === void 0 ? void 0 : _a.toString());
        ...
        return Object.assign(Object.assign({}, courseModule), { isCompleted: isModuleCompleted, lectures: processedLectures });
    });
    const overallProgressPercentage = totalLectures > 0 ? (unlockedLecturesCount / totalLectures) * 100 : 0;
